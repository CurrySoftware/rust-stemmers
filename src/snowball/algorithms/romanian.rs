...
static a_4: &'static [Among; 94] = &[
    ...
    Among("ase\u{015F}i", 29, 1, None),
    Among("sese\u{015F}i", 29, 2, None),
    Among("ise\u{015F}i", 29, 1, None),
    Among("use\u{015F}i", 29, 1, None),
    Among("\u{00E2}se\u{015F}i", 29, 1, None),
    ...
    Among("aser\u{0103}\u{0163}i", 45, 1, None),
    Among("seser\u{0103}\u{0163}i", 45, 2, None),
    Among("iser\u{0103}\u{0163}i", 45, 1, None),
    Among("user\u{0103}\u{0163}i", 45, 1, None),
    Among("\u{00E2}ser\u{0103}\u{0163}i", 45, 1, None),
    ...
    Among("ar\u{0103}m", 65, 1, None),
    Among("ser\u{0103}m", 65, 2, None),
    Among("aser\u{0103}m", 67, 1, None),
    Among("seser\u{0103}m", 67, 2, None),
    Among("iser\u{0103}m", 67, 1, None),
    Among("user\u{0103}m", 67, 1, None),
    Among("\u{00E2}ser\u{0103}m", 67, 1, None),
    Among("ir\u{0103}m", 65, 1, None),
    Among("ur\u{0103}m", 65, 1, None),
    Among("\u{00E2}r\u{0103}m", 65, 1, None),
    Among("au", -1, 1, None),
    Among("eau", 76, 1, None),
    Among("iau", 76, 1, None),
    Among("indu", -1, 1, None),
...
fn __r_prelude(env: &mut SnowballEnv, context: &mut Context) -> bool{
    ...
    fn __r_postlude(env: &mut SnowballEnv, context: &mut Context) -> bool{
        ...
        fn __r_step_0(env: &mut SnowballEnv, context: &mut Context) -> bool{
            // (, line 71
            // [, line 72
            env.ket = env.cursor;
            // substring, line 72
        ...
        fn __r_combo_suffix(env: &mut SnowballEnv, context: &mut Context) -> bool{
            // test, line 90
            let v_1 = env.limit - env.cursor;
            // (, line 90
            // [, line 91
        ...
        fn __r_standard_suffix(env: &mut SnowballEnv, context: &mut Context) -> bool{
            ...
            'replab0: loop{
                ...
                'lab1: loop{
                    ...
                    if !__r_combo_suffix(env, context){
                         break 'lab1;
                    }
                    continue 'replab0;
                    break 'lab1;
            ...
            fn __r_vowel_suffix(env: &mut SnowballEnv, context: &mut Context) -> bool{
                // (, line 217
                // [, line 218
                env.ket = env.cursor;
                // substring, line 218
            ...
            pub fn _stem(env: &mut SnowballEnv) -> bool{
                ...
                'lab7: loop{
                    ...
                    if !__r_vowel_suffix(env, context){
                         break 'lab7;
                    }
                    break 'lab7;
                }
