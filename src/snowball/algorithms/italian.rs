        ...
        fn __r_postlude(env: &mut SnowballEnv, context: &mut Context) -> bool{
            ...
            'replab0: loop{
                ...
                'lab1: loop{
                    ...
                    env.bra = env.cursor;
                    // substring, line 71
                    let among_var = env.find_among(a_1);
                    if among_var == 0{
                         break 'lab1;
                    }
                    // ], line 71
